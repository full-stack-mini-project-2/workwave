...
<head>
    ...
    <script defer type="text/javascript" src="../../../../resources/static/assets/js/traffic/traffic.js"></script>
    <script defer type="text/javascript" src="../../../../resources/static/assets/js/traffic/weather.js"></script>
    <script defer type="text/javascript" src="../../../../resources/static/assets/js/traffic/metro.js"></script>
